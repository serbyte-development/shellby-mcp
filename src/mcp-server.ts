		...
		"shell_run",
		{
			...
			inputSchema: {
				...
				command: z
					...
					.min(1)
					.max(262_144)
					.describe("Exact zsh command or multiline script. Prefer RTK for supported noisy commands; use raw shell commands for persistent state changes and unsupported operations."),
