...
A failed `/healthz` check identifies failed observation, not root cause. Inspect instance identity/port and PM2 logs. [start tests](../../../test/start.test.ts) verify command ordering with fixtures; they do not prove every live recovery scenario.
