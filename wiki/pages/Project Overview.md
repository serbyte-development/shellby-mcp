...
5. The published tool surface provides persistent and parallel shell execution, `apply_patch`, webpage fetching, dynamic workspace skills, browser-backed ChatGPT delegation, and eleven focused Peekaboo-backed Computer Use tools (`src/server/mcp-server.ts`, `src/tools/`).
