...
- Feeds: [Architecture Map](../pages/architecture-map.md), [MCP Tool Surface](../pages/mcp-tool-surface.md), [Persistent Shell Runtime](../pages/persistent-shell-runtime.md), [Workspace Tooling](../pages/workspace-tooling.md), [Configuration and Startup](../pages/configuration-and-startup.md), and [Open Questions and Risks](../pages/open-questions-and-risks.md).
...
- Stored as: [Host App Binary Survey 2026-07-20](./host-app-binary-survey-2026-07-20.md).
- Feeds: [Workspace Tooling](../pages/workspace-tooling.md).
...
- Stored as: [ChatGPT and Local Capability Survey 2026-08-01](./chatgpt-local-capability-survey-2026-08-01.md).
- Feeds: [Architecture Map](../pages/architecture-map.md) and [Open Questions and Risks](../pages/open-questions-and-risks.md).
...
- Feeds: [Architecture Map](../pages/architecture-map.md), [MCP Tool Surface](../pages/mcp-tool-surface.md), [Computer Use](../pages/computer-use.md), [Configuration and Startup](../pages/configuration-and-startup.md), and [Open Questions and Risks](../pages/open-questions-and-risks.md).
...
- Feeds: [HTTP Transport](../pages/http-transport.md).
...
- Feeds: [ChatGPT CDP Transport](../pages/chatgpt-cdp-transport.md), [Browser ChatGPT Subagents](../pages/browser-chatgpt-subagents.md), and [Subagent Completion](../pages/subagent-completion.md).
